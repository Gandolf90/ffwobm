            ...
            <div class="container py-5 h-100">
                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <p class="text-white-50 mb-5"><?= __('Please enter your username, email and password!'); ?></p>

                        <div class="form-outline form-white mb-4">
                            <?= $this->Form->control('username', ['label' => 'Username','labelOptions' => ['class' => 'form-label '], 'class' => 'form-control form-control-lg']) ?>
                        </div>
                        ...
                        <?= $this->Form->submit('Register', ['class' => 'btn btn-outline-light btn-lg px-5']) ?>
                        </div>
                        <?= $this->Form->end() ?>
                    </div>
                    </div>
